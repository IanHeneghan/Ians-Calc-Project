Nnumber = 01572147; // Put your N number here without the 'N'
...
translate([8.9264, 28.6412]) rotate([0,0,-90+72.6897]) makeLine();
translate([-29.5313, 5.28231]) rotate([0,0,-90+169.859]) makeLine();
translate([-5.28231,-29.5313]) rotate([0,0,-90+259.859]) makeLine();
translate([29.5313, -5.28231]) rotate([0,0,-90+349.859]) makeLine();
